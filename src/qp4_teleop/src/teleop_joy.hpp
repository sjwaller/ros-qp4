...
#include <qp4_msgs/BodyState.h>
#include <qp4_msgs/BodyCommand.h>
#include <qp4_msgs/GaitCommand.h>
...
class TeleopJoy {
	...
	private:
		ros::NodeHandle node;
		qp4_msgs::BodyState body_state;
		qp4_msgs::BodyCommand body_command;
		qp4_msgs::GaitCommand gait_command;
